...
const FLASH_TABLE_START_ADDR: u32 = 0x12000000;

const FLASH_TABLE_SIZE: u32 = 20*1024;

const FLASH_BOOT_PATCH_START_ADDR: u32 = 0x10010000;
...
impl Ptab {
    pub fn new(contents: &String) -> Result<Self> {
        ...
        let flash_cal_info = Info {
            base_addr: FLASH_BOOT_PATCH_START_ADDR,
            xip_addr: 0,
            size: FLASH_CAL_SIZE,
        };
        ...
        .flat_map(|pt| {
            pt.regions
                ...
                .map(|region| {
                    ...
                    let size = hex_str_to_u32(&region.offset)?;
