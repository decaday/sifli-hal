...
impl Ftab {
    ...
    pub fn apply(&mut self, table: &ptab::Ptab) {
        ...
        // ftab.c: 
        // 5(primary_bl_patch): {.base = FLASH_BOOT_PATCH_START_ADDR, 
        //     .size = FLASH_BOOT_PATCH_SIZE, 
        //     .xip_base = BOOTLOADER_PATCH_CODE_ADDR, .flags = 0}
        // 9(primary_bl_patch2): {.base = BOOTLOADER_PATCH_CODE_ADDR, 
        //     .size = FLASH_BOOT_PATCH_SIZE, 
        //     .xip_base = BOOTLOADER_PATCH_CODE_ADDR, .flags = 0}
        self.structure.ftab.primary_bl_patch.base = table.bootloader_patch_flash_info.start_addr;

        // TODO: docs say it should be flash, but code is ram
        self.structure.ftab.primary_bl_patch.xip_base = table.bootloader_patch_ram_info.start_addr;
        self.structure.ftab.primary_bl_patch.size = table.bootloader_patch_ram_info.size;

        self.structure.ftab.primary_bl_patch2.base = table.bootloader_patch_ram_info.start_addr;
        self.structure.ftab.primary_bl_patch2.xip_base = table.bootloader_patch_ram_info.start_addr;
        self.structure.ftab.primary_bl_patch2.size = table.bootloader_patch_ram_info.size;


        self.structure.ftab.secondary_bootloader.base = table.bootloader_patch_flash_info.start_addr;
        // TODO: 
        // example\flash_table\sf32lb52x\ftab.c: xip_base: flash
        // ftab.c generated by Sconscript: xip_base: ram
        self.structure.ftab.secondary_bootloader.xip_base = table.bootloader_patch_ram_info.start_addr;
        self.structure.ftab.secondary_bootloader.size = 0x80_000;
        // self.structure.ftab.secondary_bootloader.size = table.bootloader_patch_flash_info.size;

        self.structure.ftab.secondary_bootloader2.base = table.bootloader_patch_flash_info.start_addr;
        // TODO: 
        // example\flash_table\sf32lb52x\ftab.c: xip_base: flash
        // ftab.c generated by Sconscript: xip_base: ram
        self.structure.ftab.secondary_bootloader2.xip_base = table.bootloader_patch_ram_info.start_addr;
        self.structure.ftab.secondary_bootloader2.size = 0x80_000;
        // self.structure.ftab.secondary_bootloader2.size = table.bootloader_patch_flash_info.size;
        ...
        self.structure.imgs.lcpu.length = 0xFFFFFFFF;
        self.structure.imgs.secondary_bootloader.length = 0x80000;
        self.structure.imgs.secondary_bootloader.blksize = 512;
        self.structure.imgs.secondary_bootloader.flags = DFU_FLAG_AUTO;
        self.structure.imgs.primary_bl_patch.length = 0xFFFFFFFF;
        self.structure.imgs.lcpu2.length = 0xFFFFFFFF;
        self.structure.imgs.secondary_bootloader2.length = 0xFFFFFFFF;
        ...
        self.structure.running_imgs.secondary_bl = (offset_of!(structure::SecConfiguration, imgs)
            + offset_of!(structure::Imgs, secondary_bootloader)) as u32
            + table.flash_table_info.start_addr
